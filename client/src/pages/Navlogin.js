...
function Navlogin() {
  return (
    ...
    <nav className="container mx-auto flex items-center justify-between py-4">
      ...
      <div>
        <Link to="" className="px-4 py-2 bg-lime-950 text-white rounded-md hover:bg-gray-700">
          Create Account
        </Link>
      </div>
      <div>
        <Link to="/logout" className="px-4 py-2 bg-lime-950 text-white rounded-md hover:bg-gray-700">
          Logout
        </Link>
      </div>
    </nav>
